...
<html>
	...
	<body>
		...
		<div class="profileInfo">
		  <img src="../images/profile_image.png" alt="Profile Picture" style="width:100%">
		  <p class="uType">
		  <?php
		  ...
		  <p><button id="profileOUT">Sign out</button></p>
		</div>
		...
		<input type="email" placeholder="New Email Address" name="mail"><br>
			</div>
		...
		<tr><td>First Name</td><td><input type="text" name="name1"></td>
		<td id="userInfoColumn2">Last Name</td><td><input type="text" name="name2"></td></tr>
		<tr><td>Birthday</td><td><input type="date" name="BD"></td>
		<td id="userInfoColumn4">Phone Number</td><td><input type="tel" name="PhoneNumber"></td></tr>
